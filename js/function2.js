...
const selectElem = document.getElementById('repType');
...
function updateCartTotal() {
  ...
  document.getElementsByClassName('cart-total-item')[0].innerText = '$' + total
  document.getElementsByClassName('cart-total-price')[0].innerText = '$' + Math.round(total* 1.13 * 100) / 100
  document.getElementsByClassName('cart-total-tax')[0].innerText = '$' + Math.round(total* 0.13 * 100) / 100
}
